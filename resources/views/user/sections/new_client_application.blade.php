...
@section('js')
<script src="{{ asset('/danny/public/assets/user/js/bootstrap.min.js') }}"></script>
<script src="{{ asset('/danny/public/assets/user/js/bootstrap-datepicker.js') }}"></script>
<script src="{{ asset('/danny/public/assets/user/js/lib/validation/formvalidation.js') }}"></script>
<script src="{{ asset('/danny/public/assets/user/js/jquery.validate.unobtrusive.min.js') }}"></script>
<script src="{{ asset('/danny/public/assets/user/js/knockout-min.js') }}"></script>
<script src="{{ asset('/danny/public/assets/user/js/custom.js') }}"></script>
