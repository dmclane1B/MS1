...
class User extends Authenticatable
{
     ...
     * @var array
     */
    protected $fillable = ['first_name', 'last_name', 'phone', 'email', 'password', 'property_address', 'active', 'confirmation_code', 'confirmed'];
	...
	public function updateUser($updated_data , $id) {
		try {
			if( sizeof( $updated_data ) > 0 && $id ) {				
